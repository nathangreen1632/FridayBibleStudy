...
export default function ConfirmBar({
  ...
  return (
    <div className="w-full flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
      <div className="flex-1 text-sm sm:text-base text-[var(--theme-text)]">
        {message}
      </div>
      <div className="flex gap-2 justify-end">
        ...
        <button
          type="button"
          onClick={onConfirm}
          className="rounded-xl bg-[var(--theme-button)] text-[var(--theme-text-white)] px-4 py-2 hover:bg-[var(--theme-hover)]"
        >
          {confirmLabel}
        </button>
      </div>
