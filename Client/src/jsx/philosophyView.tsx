...
export default function PhilosophyView(): React.ReactElement {
  return (
    <section className="py-6 sm:py-10 px-3 sm:px-6 max-w-6xl mx-auto text-center text-[var(--theme-text)]">
      <div className="rounded-2xl sm:rounded-3xl overflow-hidden bg-[var(--theme-surface)] shadow-md md:shadow-[0_4px_14px_0_var(--theme-shadow)]">
        ...
        <div className="p-4 sm:p-6 bg-[var(--theme-surface)] text-left sm:text-center">
          <p className="text-[var(--theme-text)]/90 text-sm sm:text-lg mb-3">
